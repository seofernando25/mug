<script lang="ts">
	...
	let musicFileInput = $state<HTMLInputElement | null>(null);
	let isMusicDragging = $state(false);
	let musicFileReady = $state(false);
	let audioUrl: string | null = $state(null);

	let levelEditorTrackDiv = $state<HTMLDivElement | null>(null);
	let levelEditorHeading = $state<HTMLHeadingElement | null>(null);
	...
	let songData: Awaited<ReturnType<typeof orpcClient.song.get>> | null = $state(null);
	let chartData: Awaited<ReturnType<typeof orpcClient.song.get>>['charts'][0] | null = $state(null);
	...
	function drawHighwayLanes(
		...
		chartData: Awaited<ReturnType<typeof orpcClient.song.get>>['charts'][0] | null,
		currentWidth: number,
	...
	<div class="w-full max-w-4xl mx-auto px-4">
		...
		<div class="grid grid-cols-1 gap-6">
			{#if !musicFileReady}
				...
				>
					<h2
						class="text-3xl font-bold text-white mb-1 group-hover:text-green-200 transition-colors flex items-center"
					>
						<svg
						...
						>
							<path
								d="M464 256A208 208 0 1 0 256 464a208 208 0 1 0 0-416zm0 256A256 256 0 1 1 256 0a256 256 0 1 1 0 512zM256 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm96 96V352c0 17.7-14.3 32-32 32H192c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32 14.3 32 32zM192 192v128h96V192H192z"
							></path></svg
						>
						Upload Music
					</h2>
					...
					<div
						...
						role="button"
						tabindex="0"
						aria-label="Upload music file by dragging and dropping or clicking to select"
			...
			{:else}
				...
				>
					<h2 class="text-3xl font-bold text-white mb-4 flex items-center">
						<svg
							...
							fill="currentColor"
							><path
								d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24v80c0 13.3 10.7 24 24 24h0c13.3 0 24-10.7 24-24V288h8c13.3 0 24-10.7 24-24V224c0-13.3-10.7-24-24-24h-96V160c0-13.3-10.7-24-24-24h0c-13.3 0-24 10.7-24 24v48h-8c-13.3 0-24 10.7-24 24v32c0 13.3 10.7 24 24 24zm80-80V192h32v64H296zm-80 0v-32h32v32h-32z"
							></path></svg
						>
				...
				{#if musicFileReady}
					<div
						class="group bg-gradient-to-r from-orange-500 to-red-600 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 ease-in-out mt-6 h-170 overflow-y-auto flex flex-col"
						bind:this={levelEditorTrackDiv}
					>
						<h2
							class="text-3xl font-bold text-white mb-4 flex items-center"
							bind:this={levelEditorHeading}
						>
