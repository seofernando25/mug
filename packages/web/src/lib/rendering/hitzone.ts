import { HIT_ZONE_CENTER } from '$lib/colors';
import { HIT_ZONE_Y_RATIO, NOTE_WIDTH_RATIO } from './constants';
...
export function drawHitZone(
    ...
    const hitZoneYCenter = stageHeight * HIT_ZONE_Y_RATIO;

    const hitCircleVisualWidth = laneWidth * (NOTE_WIDTH_RATIO * 0.5);
