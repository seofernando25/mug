...
<div class="flex flex-col items-center justify-center h-full">
	...
	<div class="w-full max-w-xs">
		...
		<input type="text" id="username" class="bg-gray-700 border border-gray-600 text-gray-100 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 mb-4" placeholder="Leave empty for guest access" bind:value={usernameInput} on:keydown={handleKeydown}>
