...
export function getGameplaySizing(containerWidth?: number, containerHeight?: number) {
...
export function getNoteSize(canvasWidth?: number, canvasHeight?: number, numLanesIfKnown?: number) {
