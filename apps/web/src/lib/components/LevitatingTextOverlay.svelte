...
<div class="fixed top-0 left-0 z-50 pointer-events-none select-none">
	<div class="px-8 py-4 rounded-br-3xl bg-black/60 backdrop-blur-xl border-r-4 border-b-4 border-purple-500/50 shadow-[0_0_30px_rgba(147,51,234,0.2)] flex flex-col gap-1">
		...
		{#if difficultyName}
			<div class="mt-2 flex items-center gap-2">
				<span class="px-2 py-0.5 rounded bg-purple-500/20 border border-purple-500/40 text-[10px] font-black uppercase tracking-widest text-purple-300">
					{difficultyName}
				</span>
...
<div class="fixed bottom-0 left-0 w-full z-50 pointer-events-none select-none px-6 pb-4">
	<div class="flex flex-col gap-2">
		...
		<div class="flex justify-between items-end px-1">
			<div class="flex flex-col">
				<span class="text-2xl font-black italic tracking-tighter text-white tabular-nums drop-shadow-lg">
					{formatTime(songTimeMs)}
				</span>
			</div>
			
			<div class="flex flex-col items-end">
				<span class="text-[8px] font-black uppercase tracking-widest text-pink-400/50 leading-none mb-1">REMAINING</span>
				<span class="text-2xl font-black italic tracking-tighter text-white tabular-nums drop-shadow-lg">
		...
		<div class="w-full h-1.5 bg-gray-900/80 rounded-full overflow-hidden backdrop-blur-sm border border-white/5 relative">
			<!-- Glow effect -->
			<div 
