...
<div
	class="fixed inset-0 flex items-center justify-center overflow-hidden bg-gray-900 text-white font-sans select-none"
>
	<!-- Dynamic Background -->
	...
	<div class="relative z-10 w-full max-w-md p-6">
		...
		<div class="mb-12 text-center" in:fly={{ y: -50, duration: 800, delay: 200 }}>
			<h1
				class="text-9xl font-black italic tracking-tighter text-white drop-shadow-2xl leading-none"
			>
				MUG<span class="text-transparent bg-clip-text bg-gradient-to-br from-purple-400 to-cyan-400"
					>.</span
				>
			</h1>
			...
			>
				<div class="p-8 pb-6">
					...
					<p class="text-gray-400 text-sm leading-relaxed">
						Enter a username to start playing, or leave it blank to join as a <span
							class="text-white font-bold">Guest</span
						>.
					</p>
				</div>
				...
				<div class="px-8 pb-8 space-y-6">
					...
					{#if error}
						<div
							class="bg-red-900/30 border border-red-500/30 text-red-200 p-3 rounded-lg text-sm text-center"
							transition:fade
						>
							{error}
						</div>
					...
					<div class="text-center">
						<p class="text-[10px] text-gray-500 uppercase tracking-wide">
							...
							<a
								href="/about/terms"
								class="text-gray-400 hover:text-white underline decoration-gray-600 underline-offset-2 transition-colors"
								>Terms</a
							>
							&
							<a
