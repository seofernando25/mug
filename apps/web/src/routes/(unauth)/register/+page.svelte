		...
		>
			<form method="POST" use:enhance={handleSubmit} class="space-y-6">
				...
				<div class="space-y-2">
					<div class="flex justify-between items-center px-1">
						<label
							for="username"
							class="text-[10px] font-black uppercase tracking-widest text-gray-400">Username</label
						>
						{#if errors.username}
							<span class="text-[10px] font-bold text-red-400 uppercase tracking-tighter italic"
				...
				{#if errors.form}
					<p class="text-red-400 text-[10px] font-black uppercase text-center tracking-widest">
						{errors.form}
					</p>
				{/if}
			...
			<footer class="text-center">
				<p class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">
					...
					<a
						href="/login"
						class="text-purple-400 hover:text-purple-300 transition-colors ml-1 underline decoration-2 underline-offset-4"
						>SIGN IN</a
					>
				</p>
			</footer>
